...
void Canny(string input, char* output, float sigma, float threshold);
void Hough(char* input, char* output, float sigma, float threshold, double thre_val, unsigned char* color);
...
int FeatureDetection(char* input, char* output, float a, int b, float red, float green, float blue);
...
int FeatureMatching(char* input1, char* input2, char* output, float a, int b, float red, float green, float blue);
...
vector<vector<double>> Correction(string input, char* output, int A_height, int A_width, double thre_val, double sigma, double threshold, int angle_num, int range_thre, double fun_thre, int point_thre);
vector<double> CalibrationAndCorrection(char* input, char* output1, char* output2, double sigma, double gra_threshold, double vote_threshold, double peak_dis, unsigned char* lines_color, unsigned char* intersections_color);
...
void CannyProcessing(char* input, char* output, int a);
void AverageGrayScale(char* input, char* output);
void SimpleBW(char* input, char* output);
void AdvancedBW(char* input, char* output);
void UniformNoise(char* input, char* output);
void GaussianNoise(char* input, char* output, double sigma);
void SaltAndPepperNoise(char* input, char* output);
void MeanFilter(char* input, char* output, int filterSize);
void GaussianFilter(char* input, char* output, double sigma);
void MedianFilter(char* input, char* output, int size);
void EfficientMeanFilter(char* input, char* output, int filterSize);
double MeanSquaredError(char* input1, char* input2, char* output);
